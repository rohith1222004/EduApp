...
[
  {
      "question": "What is the purpose of the flattened layer in building a neural network with TensorFlow?",
      "options": [
          {"a": "To convert the input image into a one-dimensional array"},
          {"b": "To add more layers to the neural network"},
          {"c": "To optimize the loss function"}
  ...
  {
      "question": "What is the activation function used in the dense layer with 128 fully connected neurons?",
      "options": [
          {"a": "Sigmoid"},
          {"b": "Rectified Linear"},
          {"c": "Tanh"}
  ...
  {
      "question": "What is the purpose of the output layer in the neural network for predicting clothing types?",
      "options": [
          {"a": "To convert the output into a one-dimensional array"},
          {"b": "To determine the importance of a given variable"},
          {"c": "To predict the likelihood of an image being a certain type of clothing"}
      ],
      "answer": "c"
  }
]